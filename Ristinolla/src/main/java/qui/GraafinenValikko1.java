 ...
 */
public class GraafinenValikko1 extends JPanel{
    
    public GraafinenValikko1() {
        setOpaque(true);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("Yritit klikata ruutua, joka on jo täytetty... ", 20, 155);
        
        g.drawString("Jatka peliä!", 150, 200);
