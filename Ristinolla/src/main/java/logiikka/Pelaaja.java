...
/**
 * Luokka tarjoaa pelaajien vuorojen hallintaan tarvittavat apumetodit sekä pitää muistissa pelaajan omaaman merkin sekä pelattujen merkkien määrän. 
 */
public class Pelaaja {
    ...
    /**
     * Metodi kasvattaa pelattujen merkkien maaraa yhdellä. Metodin parametri on toistaiseksi turha.
    ...
    /**
     * Metodi palauttaa on lähinnä tekstikäyttöliittymää varten. 
     * @return Plautus on muotoa "Pelaaja X" tai "Pelaaja Y"
     */
    @Override
